...
class AddressOptionItem extends StatelessWidget {
  ...
  AddressOptionItem({required this.title, required this.icon, required this.subTitle, required this.onTapEdit,required this.index,required this.onTapDelete});
                ...
                child: InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(child: Icon(Icons.delete,color: Colors.red,),onTap: onTapDelete,)
